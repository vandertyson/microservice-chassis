...
/bin/cp -rf $CONTAINER_PATH/mix4core/etc/* $CONTAINER_PATH/deploy/
...
sleep 5
deploy_layer microchassis-abm-4x inner1.yml
sleep 5
deploy_layer microchassis-chp-4x inner2.yml
sleep 5
deploy_layer microchassis-cgw-4x inner3.yml
sleep 15
